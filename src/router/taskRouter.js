...
import { deleteTask ,insertTask, updateTask } from '../models/taskModels/TaskSchema.js'; // now we don't need to use TaskCollection name we can use second because we used default keyword in the export of taskSchema.js file
